...
<body>
    ...
    border-style:outset;border-width: 5px;padding: auto;
    text-overflow: clip;
    ...
    .search-bar button:hover {
        background-color: #e55342; /* Darker tomato color */
    }
...
a{text-size-adjust: 100px;}



p{
    font-size: large;
    forced-color-adjust: tomato;
}
h6{
    font-size: xx-large;
    color:tomato;
...
.form-box {
    align-self: center;
    background-image: url("Sakuna.jpg");
    justify-self: center;
    position: ;
    align-items: center;
    display: flex;
...
.social-icons img.social-icon {
    ...
    border-radius: 50%; /* Optional: make the icons round */
...
.social-icons a {
    ...
    background-size: cover;
    background-repeat: no-repeat;
    animation: animateBackground 20s infinite alternate linear;
}
...
.layer1 {
    background-image: url('naruto-layer1.jpg');
    transform: translateZ(-1px) scale(2);
}

.layer2 {
    background-image: url('naruto-layer2.jpg');
...
.add-button {
    ...
    width: 100px;
    height: 100px;
    background-image: url('kindpng_4381798.png');
    background-size: cover;
    background-repeat: no-repeat;
    animation: run 10s linear infinite; /* Adjust duration and timing function as needed */
}

@keyframes run {
    0% { left: -100px; transform: scaleX(1); }
    50% { transform: scaleX(-1); } /* Flip the image horizontally */
